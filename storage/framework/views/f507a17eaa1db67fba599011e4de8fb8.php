...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Panel'); ?> — E-Procurement</title>
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/auth/favicon.png')); ?>">
...
<div class="flex h-full min-h-screen bg-[#F0F2F5] text-gray-800">
    ...
    <aside class="hidden md:flex w-64 flex-col bg-[#3553A8] border-r border-[#4A6BCC] flex-shrink-0">
        ...
        <div class="flex h-[72px] items-center px-6 border-b border-[#4A6BCC]">
            <img src="<?php echo e(asset('images/auth/logo.png')); ?>" alt="E-Tender Logo" class="h-14 w-auto object-contain">
        </div>

        <nav class="flex-1 space-y-2 px-4 py-6">
            <a href="<?php echo e(route('admin.dashboard')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                      <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
            ...
            <a href="<?php echo e(route('admin.vendors.index')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                      <?php echo e(request()->routeIs('admin.vendors*') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
            ...
            <a href="<?php echo e(route('admin.vendors.blacklist.index')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                      <?php echo e(request()->routeIs('admin.vendors.blacklist*') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
            ...
            <a href="<?php echo e(route('admin.submissions.index')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                      <?php echo e(request()->routeIs('admin.submissions*') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
            ...
            <a href="<?php echo e(route('admin.tenders.index')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                      <?php echo e(request()->routeIs('admin.tenders*') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
            ...
            <a href="<?php echo e(route('admin.audit-logs.index')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                      <?php echo e(request()->routeIs('admin.audit-logs*') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
            ...
            <a href="<?php echo e(route('admin.complaints.index')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                       <?php echo e(request()->routeIs('admin.complaints*') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
                ...
                <?php $pendingComplaints = \App\Models\TenderComplaint::where('status','pending')->count(); ?>
                <?php if($pendingComplaints > 0): ?>
                    <span class="ml-auto inline-flex h-5 min-w-[1.25rem] items-center justify-center rounded-full bg-red-400 px-1.5 text-[10px] font-bold text-white"><?php echo e($pendingComplaints); ?></span>
                <?php endif; ?>
            </a>

            <a href="<?php echo e(route('admin.contracts.index')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                       <?php echo e(request()->routeIs('admin.contracts*') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
            ...
            <a href="<?php echo e(route('admin.settings.index')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                       <?php echo e(request()->routeIs('admin.settings*') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
            ...
            <a href="<?php echo e(route('admin.reports.index')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                      <?php echo e(request()->routeIs('admin.reports*') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
            ...
            <a href="<?php echo e(route('admin.catalogue.index')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                       <?php echo e(request()->routeIs('admin.catalogue*') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
            ...
            <a href="<?php echo e(route('admin.users.index')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                       <?php echo e(request()->routeIs('admin.users*') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
            ...
            <a href="<?php echo e(route('admin.admin.ai.index')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                       <?php echo e(request()->routeIs('admin.admin.ai*') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
            ...
            <a href="<?php echo e(route('admin.admin.blockchain.index')); ?>"
               class="flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold
                       <?php echo e(request()->routeIs('admin.admin.blockchain*') ? 'bg-white text-[#3553A8]' : 'text-white hover:bg-[#2B438A]'); ?>
    ...
    <aside id="mobile-sidebar"
        ...
        <div class="flex h-[72px] items-center justify-between px-5 border-b border-[#4A6BCC]">
            <img src="<?php echo e(asset('images/auth/logo.png')); ?>" alt="E-Tender Logo" class="h-12 w-auto object-contain">
            ...
            <div class="flex items-center gap-2 md:gap-8 flex-shrink-0">
                <div class="flex items-center gap-2 md:gap-3">
                    <span class="hidden sm:block text-sm font-medium text-white truncate max-w-[120px] md:max-w-none">
                        <?php echo e(auth()->user()->name ?? 'Admin Tender'); ?>

                    </span>

                    
                    <div class="flex items-center gap-1 bg-gray-100 rounded-lg p-1 text-xs font-semibold">
                        <a href="?lang=id" class="px-2 py-1 rounded <?php echo e(app()->getLocale() === 'id' ? 'bg-white shadow text-blue-700' : 'text-gray-500 hover:text-gray-700'); ?>">ID</a>
                        <a href="?lang=en" class="px-2 py-1 rounded <?php echo e(app()->getLocale() === 'en' ? 'bg-white shadow text-blue-700' : 'text-gray-500 hover:text-gray-700'); ?>">EN</a>
                    </div>

                    <div class="h-9 w-9 md:h-10 md:w-10 overflow-hidden rounded-full border-2 border-white/20 flex-shrink-0">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->name ?? 'Admin')); ?>&background=28C5D4&color=fff" alt="Avatar" class="h-full w-full object-cover">
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\project-laravel\lelang-2.0\resources\views/layouts/admin.blade.php ENDPATH**/ ?>