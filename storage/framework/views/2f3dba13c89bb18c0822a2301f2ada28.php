<?php $__env->startSection('title', 'Pengaturan Instansi'); ?>
<?php $__env->startSection('page-title', 'Pengaturan Instansi & White-Label'); ?>
...
<div class="max-w-3xl space-y-6">
    ...
    <form method="POST" action="<?php echo e(route('admin.settings.update')); ?>"
        ...
        ?>
        <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $opt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div>
            <label class="block text-xs font-semibold text-gray-600 mb-1"><?php echo e($opt['label']); ?></label>
            <input type="text" name="<?php echo e($key); ?>" value="<?php echo e($settings[$key] ?? ''); ?>"
                   placeholder="<?php echo e($opt['placeholder']); ?>"
        ...
        <div>
            ...
            <div class="flex items-center gap-3">
                <input type="color" name="primary_color" value="<?php echo e($settings['primary_color'] ?? '#3553A8'); ?>"
                       class="h-10 w-14 rounded cursor-pointer border border-gray-300">
                <input type="text" id="color-text" value="<?php echo e($settings['primary_color'] ?? '#3553A8'); ?>"
        ...
        <div class="flex items-center gap-3 pt-2">
            <label class="relative inline-flex items-center cursor-pointer">
                ...
                <input type="checkbox" name="enable_2fa" value="true" class="sr-only peer"
                        <?php echo e(($settings['enable_2fa'] ?? 'false') === 'true' ? 'checked' : ''); ?>>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="mb-4">
            ...
            <img src="<?php echo e(asset('storage/' . $settings['instansi_logo'])); ?>"
                 alt="Logo Instansi" class="h-20 object-contain rounded border p-2">
        </div>
        <?php endif; ?>
        <form method="POST" action="<?php echo e(route('admin.settings.logo')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\project-laravel\lelang-2.0\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>