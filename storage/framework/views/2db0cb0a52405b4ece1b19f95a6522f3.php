...
<table class="header-table">
  <tr>
    <td style="width: 20%;">
      <?php if($logoSrc): ?>
        <img src="<?php echo e($logoSrc); ?>" style="max-height: 50px;" alt="Logo">
      <?php endif; ?>
    </td>
    <td style="text-align: right; width: 80%;">
      <div class="logo-text"><?php echo e(strtoupper($settings['instansi_name'] ?? 'ZETA')); ?></div>
  ...
  <table style="width:100%; border:none;">
    <tr>
      <td style="border:none; text-align:left; padding:0; font-weight:bold;">
        ZETA HEAD OFFICE<br>
        <span style="font-weight:normal; color:#555;"><?php echo e($settings['instansi_address'] ?? 'Gedung Pusat Pengadaan, Jakarta, Indonesia'); ?></span>
      </td>
      <td style="border:none; text-align:right; padding:0; color:#555;">
        Telp: <?php echo e($settings['instansi_phone'] ?? '-'); ?> | Email: <?php echo e($settings['instansi_email'] ?? '-'); ?><br>
...
<?php /**PATH C:\project-laravel\lelang-2.0\resources\views/pdf/layout.blade.php ENDPATH**/ ?>